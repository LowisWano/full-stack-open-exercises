...
describe('Blog component', () => {
  ...
  beforeEach(() => {
    mockHandler = vi.fn()
    container = render(<Blog blog={test_blog} user={test_user} updateLikesBlog={mockHandler}/>).container
  })
...
test('form event handler is called with the right details when a new blog is created', async () => {
  ...
  expect(mockHandler.mock.calls[0][0].url).toBe('https://www.youtube.com/watch?v=PmHlYDAxSOM')
})
